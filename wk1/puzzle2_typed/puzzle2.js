...
/**
 * Sets up a new round by generating secret number and updating display
 * @returns {void} - Updates global variables and DOM elements
 */
function setupRound() {
...
/**
 * Starts the guess processing chain
 * @returns {void} - Calls captureGuess to continue the chain
 */
function startChain() {
    captureGuess();
}
...
/**
 * Captures and validates user input from the input field
 * @returns {void} - Calls checkGuess with validated number or shows error
 */
 ...
 * @returns {void} - Calls displayFeedback with result
 */
...
/**
 * Displays feedback to player and determines if round should end
 * @param {string} result - Feedback message ("Too high!", "Too low!", "Correct!")
 * @param {boolean} isCorrect - Whether the guess was correct
 * @returns {void} - Updates DOM and may call endRound
 */
...
/**
 * Handles the end of a round by calculating score and setting up next action
 * @param {boolean} won - Whether the player won this round
 * @returns {void} - Updates score display and button functionality
 */
...
/**
 * Checks if game should continue to next round or end
 * @returns {void} - Either calls setupRound for next round or finalizeGame
 */
...
/**
 * Ends the game and displays final score with performance message
 * @returns {void} - Updates final message and disables button
 */
 ...
 * @returns {void} - Calls checkGameEnd to advance game
 */
 ...
 * @returns {void} - Calls finalizeGame to end game
 */
function finishGame() {
    finalizeGame();
}
